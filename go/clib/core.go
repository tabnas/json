...
//
// libtabnasjson is the json format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/json/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasjson"
	formatName      = "json"
	valueOut        = true
)
...
// newParser builds one engine with the json grammar installed
...
// parseWith answers whether src is in the json language — and,
